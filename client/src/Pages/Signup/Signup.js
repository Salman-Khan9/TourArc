...
const Signup = () => { 
    ...
    <Form  {...form} >
      <div className="h-screen w-screen flex justify-center items-center">
        <div className=" w-[750px] flex justify-center space-x-12 bg-gray-200 rounded p-5 shadow-2xl border-2 border-gray-300        ">
          ...
          <img className="md:block relative hidden w-[320px] h-[450px] m-5 " src={loginimage} alt="signup " ></img>
      <form onSubmit={form.handleSubmit(onSubmit)} className="  w-[300px] space-y-3 mt-6">
  ...
  /> 
        ...
        <p className="w-full flex justify-center ">Already have an account? <Link className="font-bold text-sky-700 hover:text-sky-600 " to="/login" >Login</Link> </p>
      </form>
      </div>
      </div>
    </Form>
